    ...
    return (
        <form className="recipeForm">
            <fieldset className="recipe__ingredients">
                ...
                <input autoFocus type="text" className="input__box" value={recipe.name} onChange={
                    (e) => {
                        const copy = {...recipe}
                ...
                <input type="text" className="input__box" value={recipe.style} onChange={
                    (e) => {
                        const copy = {...recipe}
                ...
                <input type="text" className="input__box" value={recipe.malts} onChange={
                    (e) => {
                        const copy = {...recipe}
                        copy.malts = e.target.value
                        update(copy)}
                    }/>
                <label htmlFor="hopes">Hops:</label>
                <input type="text" className="input__box" value={recipe.hops} onChange={
                    (e) => {
                        const copy = {...recipe}
                ...
                <input type="text" className="input__box" value={recipe.yeast} onChange={
                    (e) => {
                        const copy = {...recipe}
                ...
                <input type="text" className="input__box" value={recipe.adjuncts} onChange={
                    (e) => {
                        const copy = {...recipe}
            ...
            <label htmlFor="guide">Describe the Process:</label>
                <input type="text" className="input__box" value={recipe.recipeGuide} onChange={
                    (e) => {
                        const copy = {...recipe}
